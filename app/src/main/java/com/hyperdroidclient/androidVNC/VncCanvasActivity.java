...
public class VncCanvasActivity extends Activity implements View.OnGenericMotionListener {
    ...
    ZoomControls zoomer;
    Panner panner;
    ImageView bDisconnect;
    ImageView mZoomKeyboard;
    ImageView ivHelp;
    @Override
    public void onCreate(Bundle icicle) {
        ...
        bDisconnect = (ImageView) findViewById(R.id.bDisconnect);
        mZoomKeyboard = (ImageView) findViewById(R.id.ivKeyboard);
        ...
        mZoomKeyboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void removeUUID() {
        ...
        databaseReference.child("VirtualMachine").child(new SharedPreferenceManager(getApplicationContext()).getVMKey()).child("UUID").setValue("");
    }
